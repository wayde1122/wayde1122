<p align="center">
  <img width="350px" src="https://capsule-render.vercel.app/api?type=wave&color=0:0A0F33,100:1F4068&height=120&section=header&text=wayde1122&fontSize=40&fontColor=FFFFFF" />
</p>
...
### 🔗 AI & Frontend Agent Projects

- 🚀 **chat_box_code** — AI 聊天组件示例（TypeScript）  
  https://github.com/wayde1122/chat_box_code :contentReference[oaicite:2]{index=2}

- 🤖 **first-agent** — JavaScript Agent Demo  
  https://github.com/wayde1122/first-agent :contentReference[oaicite:3]{index=3}

- 🧠 **w-agent** — Python Agent 核心示例  
  https://github.com/wayde1122/w-agent :contentReference[oaicite:4]{index=4}

- 🔄 **fork-openmanus** — Fork 自项目并修改（Python）  
  https://github.com/wayde1122/fork-openmanus :contentReference[oaicite:5]{index=5}
